...
trait HFileUtils extends Serializable {
  ...
  def rowToEntCalculations(row: Row, appParams: AppParams): Seq[(String, HFileCell)] = {
  ...
  def rowToLouCalculations(row: Row, appParams: AppParams): Option[(String, HFileCell)] = {
  ...
  def leuToLinks(row: Row, appParams: AppParams): Seq[(String, HFileCell)] = {
  ...
  def createEnterpriseCell(ern: String, column: String, value: String, appParams: AppParams): (String, HFileCell) = createRecord(generateEntKey(ern, appParams), appParams.HBASE_ENTERPRISE_COLUMN_FAMILY, column, value)

  def createLocalUnitCell(lurn: String, ern: String, column: String, value: String, appParams: AppParams): (String, HFileCell) = createRecord(generateLocalUnitKey(lurn, ern, appParams), appParams.HBASE_LOCALUNITS_COLUMN_FAMILY, column, value)

  def createLegalUnitCell(ubrn: String, ern: String, column: String, value: String, appParams: AppParams): (String, HFileCell) = createRecord(generateLegalUnitKey(ubrn, ern, appParams), appParams.HBASE_LEGALUNITS_COLUMN_FAMILY, column, value)
  ...
  def generateErn(row: Row, appParams: AppParams): String = generateUniqueKey

  def generateRurn(row: Row, appParams: AppParams): String = generateUniqueKey

  def generatePrn(row: Row, appParams: AppParams): String = {
  ...
  def generateLurn(row: Row, appParams: AppParams): String = generateUniqueKey

  def generateLurnFromEnt(row: Row, appParams: AppParams): String = generateUniqueKey
