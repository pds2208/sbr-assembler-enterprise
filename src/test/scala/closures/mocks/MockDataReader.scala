...
trait MockDataReader {
  this: BaseClosure =>

  override def getExistingLinksLeusDF(appParams: AppParams, confs: Configuration)(implicit spark: SparkSession): DataFrame = {
  ...
  override def getExistingLeusDF(appParams: AppParams, confs: Configuration)(implicit spark: SparkSession): DataFrame = {
  ...
  override def getExistingRusDF(appParams: AppParams, confs: Configuration)(implicit spark: SparkSession): DataFrame = {
  ...
  override def getExistingLousDF(appParams: AppParams, confs: Configuration)(implicit spark: SparkSession): DataFrame = {
  ...
  override def getExistingEntsDF(appParams: AppParams, confs: Configuration)(implicit spark: SparkSession): DataFrame = {
